...
public class ArrayListTest {
  ...
  public void addElementToArrayList() {
    ...
    Assert.assertNull("Test failed! Element is not added correctly\n", arrayList.get(1));
    Assert.assertEquals("Test failed! Element is not added correctly\n",
      "for", arrayList.get(2));
    Assert.assertEquals("Test failed! Element is not added correctly\n",
  ...
  public void addListToArrayList() {
    ...
    newArrayList.add("Kyiv");
    arrayList.addAll(newArrayList);
    Assert.assertEquals("Test failed! Size of array should be " + 5 + "but it is "
      + arrayList.size() + "\n", 5, arrayList.size());
    Assert.assertEquals("Academy", arrayList.get(3));
    Assert.assertEquals("Kyiv", arrayList.get(4));
  }
  ...
  public void removeElementFromArrayListByIndex() {
    ...
    Assert.assertNull("Test failed! Can't remove element by index \n", arrayList.get(0));
  ...
  public void checkIsNotEmpty() {
    ...
    arrayList.add("Second");
    arrayList.add("Third");
    Assert.assertEquals("Test failed! ArrayList shouldn't be empty\n", false, arrayList.isEmpty());
  }

  @Test
  public void checkIsEmpty() {
    ArrayList<String> arrayList = new ArrayList<>();
    Assert.assertEquals("Test failed! ArrayList should be empty\n", true, arrayList.isEmpty());
    arrayList.add("First");
    arrayList.remove(0);
    Assert.assertEquals("Test failed! ArrayList should be empty\n", true, arrayList.isEmpty());
  }
